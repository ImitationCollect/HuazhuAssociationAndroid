...
let IconBiaoqiankuozhanWode395: FunctionComponent<Props> = ({ size, color, ...rest }) => {
    return (
        <Svg viewBox="0 0 1024 1024" width={size} height={size} {...rest}>
            <Path
                d="M584.3456 165.6832c1.2288 9.5744 1.8944 19.2512 1.8944 29.1328 0 127.3856-103.2704 230.656-230.656 230.656-3.8912 0-7.7824-0.1024-11.6224-0.3072 30.7712 63.2832 95.6928 106.9568 170.8032 106.9568 104.8576 0 189.8496-84.992 189.8496-189.8496 0-80.2304-49.8688-148.8384-120.2688-176.5888z"
            ...
            />
            <Path
                d="M708.096 587.2128c-37.3248-30.3616-53.248-35.2768-102.2464-49.9712-64.8192 136.5504-231.6288 224.7168-392.8576 224.7168-19.968 0-39.5776-1.4848-58.7776-4.3008a374.4 374.4 0 0 0-28.3136 132.9664c-0.1536 5.7344 4.5568 10.3936 10.24 10.3936h730.5216c5.7344 0 10.3936-4.6592 10.24-10.3936-3.3792-126.8224-76.6976-228.4032-168.8064-303.4112z"
...
IconBiaoqiankuozhanWode395 = React.memo ? React.memo(IconBiaoqiankuozhanWode395) : IconBiaoqiankuozhanWode395;

export default IconBiaoqiankuozhanWode395;
